...
public class WorldGenHighlandsGroundcover extends WorldGenerator
{
    ...
    private final BlockTallGrass tallGrassID;
    ...
    {
        Block var11 = par1World.getBlock(par3, par4, par5);

        while (par4 > 0 && (var11.isAir(par1World, par3, par4, par5) || var11.isLeaves(par1World, par3, par4, par5)))
        {
            par4--;
            var11 = par1World.getBlock(par3, par4, par5);
        }
