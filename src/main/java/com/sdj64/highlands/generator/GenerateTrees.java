...
public class GenerateTrees implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world,
		...
		if(world.provider.getDimensionId() == 0){
			...
			if(biome.equals(BiomeGenBase.taiga) || biome.equals(BiomeGenBase.coldTaiga) && random.nextInt(12) == 1){
				new WorldGenMegaPineTree(false, true).generate(world, random, pos2);
			}
			else if(biome.equals(BiomeGenBase.taiga) || biome.equals(BiomeGenBase.coldTaiga) ){//&& random.nextInt(2) == 1){
